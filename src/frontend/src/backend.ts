...
export class Backend implements backendInterface {
    ...
    async addChecklistItem(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getChecklistItemsByDate(arg0: string): Promise<Array<ChecklistItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getChecklistItemsByDate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentInvoiceCounter(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentInvoiceCounter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetChecklistForNewDay(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetChecklistForNewDay(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveLowStockThreshold(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveLowStockThreshold(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleChecklistItem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateTask(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
